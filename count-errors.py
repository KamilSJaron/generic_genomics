...
best_align = {}
sbam = pysam.Samfile(sys.argv[1])
#sbam = pysam.Samfile('unsrt_vs_tcristinae.last.bam')
#sbam = pysam.Samfile('amphioPBvIl.fa.bam')
...
for query in best_align: #query = 'b198d990-1de2-4705-9ad1-eaf23d117e61_Basecall_Barcoding_2d'
